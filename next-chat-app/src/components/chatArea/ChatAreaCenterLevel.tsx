...
const ChatAreaCenterLevel = ({ chatMessageSlice, userRecord }: any) => {
  ...
  return (
    <>
      {chatMessageSlice.chatMessages?.map((message: any, index: number) => {
        ...
        const translatedMessage = message.translatedMessage.find(
          (translatedMessage: any) => translatedMessage?.user === userRecord._id
        );
          ...
          if (message.type === "image") {
            ...
            const documentFormat = () => {
              if (ext === "pdf") {
                return (
                  <span className="messageList">
                    <span>
                      <FaFilePdf size={25} className="documentSavePdf" />
                      <span className="documentTitle">{message.message}</span>
                    </span>
                  </span>
                );
                ...
                return (
                  <span className="messageList">
                    <span>
                      <FaFileWord size={25} className="documentSaveWord" />
                      <span className="documentTitle">{message.message}</span>
                    </span>
              ...
              <div className="chatAreaCenterTexts">
                <div className="chatAreaCenterContent">
                  ...
                  <div className="chatAreaMessage">
                    ...
                    <span>
                      <span className="messageLink">{message.message}</span>
                    </span>{" "}
                    <br />{" "}
                    <div className="messageTime">
                      {getStarMessage && <FaStar />}{" "}
            ...
            return (
              <div className="chatAreaCenterTexts">
                <div className="chatAreaCenterContent">
                  <div className="chatAreaMessage">
                    <span className="actionMessageList">{message.message}</span>{" "}
                  </div>
                </div>
              </div>
            );
              ...
              <div className="chatAreaCenterTexts">
                <div className="chatAreaCenterContent">
                  ...
                  <div className="chatAreaMessage">
                    ...
                    <span className="messageList"> {message.message}</span>{" "}
                    <br />{" "}
                    <div className="messageTime">
                      {getStarMessage && <FaStar />}{" "}
          ...
          <div
            className={`${
              message.sender._id === userRecord._id
                ...
                : `message ${message.type === "action" && "actionMessage"}`
            } `}
            key={index}
          >
            <>{showMessages()}</>
