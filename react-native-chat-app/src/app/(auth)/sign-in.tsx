...
import { loginForm } from "@/src/components/formValidation/formValidation";
import {
  errorPopupActions,
  isLoadingActions,
} from "@/src/redux-toolkit/reducers/actionsSlice";
import { signIn, updateUserProfile } from "@/src/services/usersServices";
          ...
          <View style={authStyles.header}>
            <View style={authStyles.member}>
              ...
              <View>
                ...
                >
                  <Text style={authStyles.memberSignInUp}>Sign up</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
