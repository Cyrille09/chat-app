...
export async function sendGroupImage(data: {}) {
  return await axiosInterceptors.post(`/messages/send/image/group`, data, {
    headers: { multipartFormData: "multipart/form-data" },
  });
}
export async function sendGroupAudio(data: {}) {
...
export async function sendGroupDocument(data: {}) {
 ...
 */
export async function updateMessage(messageDetail: {}, id: string) {
